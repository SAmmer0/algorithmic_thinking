...
# conditional imports
if DESKTOP:
    # desktop project solution
    import week2_pjt_template as alg_project3_solution
    import week2_pjt_matplotlib_plot as alg_clusters_matplotlib
    import week2_pjt_cluster as alg_cluster
else:
    # import userXX_XXXXXXXX as alg_project3_solution   # CodeSkulptor project
    # solution
...
def load_desktop_data(fpath):
    '''
    Load data file from desktop file
    '''
...
def run_example():
    ...
    data_table = load_desktop_data('week2_data_111.csv')
